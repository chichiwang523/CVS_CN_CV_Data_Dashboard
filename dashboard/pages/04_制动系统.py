...
st.set_page_config(page_title="制动系统", layout="wide")
st.markdown("# 🛑 制动系统分析 Braking System")
st.caption("ABS/EBS 市场份额 — ZF/威伯科 vs Bosch/博世 vs Knorr/克诺尔")
...
main_suppliers = ["ZF/威伯科", "Knorr/克诺尔", "Bosch/博世", "瑞立科密", "万安科技"]
...
with col4:
    st.subheader("ZF/威伯科 ABS 产品型号 Top 15")
