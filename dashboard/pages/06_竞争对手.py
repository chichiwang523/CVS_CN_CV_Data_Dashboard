...
st.set_page_config(page_title="竞争对手分析", layout="wide")
st.markdown("# 🏭 竞争对手分析 Competitor Analysis")
st.caption("ZF/威伯科 vs Bosch/博世 vs Knorr/克诺尔 — 基于公告备注提及频次")
...
cols = ["ZF/威伯科_ratio", "Bosch/博世_ratio", "Knorr/克诺尔_ratio"]
...
cols_abs = ["ZF/威伯科", "Bosch/博世", "Knorr/克诺尔"]
